  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        <p className="text-[13px] text-neutral-500 dark:text-neutral-400 leading-relaxed font-light">
          {place.intro}
        </p>
      </div>
      ...
      >
        ...
        <div>
          <div className="mb-3">
            <h3 className="font-['Bebas_Neue'] text-[28px] leading-none tracking-wide text-white">
              {place.name}
            </h3>
          ...
          <div className="mb-3">
            <p className="text-[9px] text-white/40 uppercase tracking-[0.15em] mb-1 font-medium">
              Famous for
            </p>
          ...
          <div className="flex flex-wrap gap-1.5">
            {place.cuisine.map((c) => (
              <span
                key={c}
                className="text-[10px] px-2 py-0.5 border border-white/20
                           text-white/60 rounded-sm uppercase tracking-wider"
              >
                {c}
              </span>
            ))}
            {place.vibe.map((v) => (
              <span
                key={v}
                className="text-[10px] px-2 py-0.5 border border-white/10
                           text-white/40 rounded-sm uppercase tracking-wider"
              >
                {v}
              </span>
            ))}
        ...
        {/* Bottom: rating + hours */}
        <div
          className="flex items-end justify-between pt-3 border-t border-white/10"
        >
          <div>
